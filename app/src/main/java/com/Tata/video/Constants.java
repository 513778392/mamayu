...
import static com.Tata.video.utils.WordUtil.getString;
...
//    public static final String GENDER_MALE = R.string.男;
//    public static final String GENDER_FAMALE = R.string.女;
...
//    public static final String YB_NAME_1 = R.string.官方;
//    public static final String YB_NAME_2 = R.string.系统通知;
    ...
    public static final String SIGN_1 = "#d51251e410368a0";
    public static final String SIGN_2 = "d586e01";
    public static final String SIGN_3 = "d5186e";
    ...
    static {
        ...
        GENDER_MAP.put(1, getString(R.string.man));
        GENDER_MAP.put(2, getString(R.string.woman));
    }
